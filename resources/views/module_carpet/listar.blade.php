    ...
    <table class="table">
        @foreach ($students as $dato)
            ...
            <tr>
                ...
                <td><a href="{{ route('teacher.show', $dato->id) }}" style="text-decoration: none">Mostrar</a></td>
                <td><a href="{{ route('teacher.edit', $dato->id) }}" style="text-decoration: none">Editar</a></td>
                <td>
